...
<label class="pull-right edit_myacount" data-from="admin" style="cursor: pointer;font-size: 24px"><small>Edit <i class="glyphicon glyphicon-pencil"></i></small></label></h2>
<?php echo $error;?>
<?php echo form_open('admin/edit_acount');?>
